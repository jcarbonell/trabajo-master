...
score_function_names <- c("default_score","default_score1b","default_score2")
...
paint_score_density(sre$score_runs[[2]],label=score_function_names[2],"gene_cluster_score")
paint_score_density(sre$score_runs[[2]],label=score_function_names[2],"gene_cluster_score")
